...
const PRICING = [
  {
    ...
    price: "$0",
    period: "forever",
    features: ["Level 1 (all sub-levels)", "2 themes", "Basic word bank", "1 reader profile"],
    cta: "Start Free",
    href: "/sign-up",
    highlight: false,
  },
  {
    ...
    price: "$7.99",
    period: "per month",
    features: ["All 5 levels", "All 5 themes", "200+ stickers", "Up to 4 profiles", "Parent dashboard + PDF reports"],
  ...
  },
  {
    ...
    price: "$299",
    period: "per year",
    features: ["Everything in Individual", "Up to 30 student profiles", "Teacher management view", "Class progress reports"],
    cta: "For Schools",
    href: "/sign-up",
    highlight: false,
  },
